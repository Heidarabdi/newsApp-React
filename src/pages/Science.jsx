...
function Science() {
  ...
  useEffect(() => {
    axios.get(
      `https://newsapi.org/v2/top-headlines?country=us&category=science&apiKey=${api}`
    ).then((res) => {
  ...
  return (
    <main className="w-full grid grid-cols-1 md:grid-col-1">
      ...
      <div className='md:w-[70%] p-6 '>
        <h1 className="text-3xl font-bold text-blue-500 font-[MaryToddW00-light] pb-3">Top Science News</h1>
